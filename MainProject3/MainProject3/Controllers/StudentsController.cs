...
namespace MainProject3.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,ID,Name,Gender,DOB,Phone,Address,ClassID,Admission")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,ID,Name,Gender,DOB,Phone,Address,ClassID,Admission")] Student student)
        {
            if (ModelState.IsValid)
            {
