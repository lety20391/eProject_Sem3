...
namespace MainProject3.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ExamID,ID,Path,Quotation,Story,IDStudent,IDCompetition,IDExhibition,Mark,IDAward,ChangeDescription,Status,MoneyReturn,Price,Improvement")] Exam exam)
        {
